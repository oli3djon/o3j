<?php 
 ...
 $from=$_POST["email"];
 $msg=$_POST["message"];
 $receiver="oli3djon@mail.ru";
 $subject="Contact us form details";

 if(mail()){
  echo("Успешно отправиено")
}
$message = "
<html>
<head>
...
<table width='50%' border='0' align='center' cellpadding='0' cellspacing='0'>
  <tr>
    <td colspan='2' align='center' valign='top'><img src='http://www.o3j.uz/images/logo.png' width='140' height='140'></td>
  </tr>
  <tr>
...
$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
 ...
 // Additional headers
 $headers .= 'To: Mary <oli3djon@mail.ru>, Kelly <oli3djon@mail.ru>' . "\r\n";
 $headers .= 'From: Напоминание о дне рождения <oli3djon@mail.ru>' . "\r\n";
